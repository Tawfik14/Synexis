...
public function historiqueObjet(int $id, ObjectLogRepository $logRepo, ObjetRepository $objetRepo): Response
{
    ...
    #[IsGranted('IS_AUTHENTICATED_FULLY')]
    public function myServices(ServiceRepository $serviceRepo): Response
    {
        $user = $this->getUser();
    ...
    #[IsGranted('IS_AUTHENTICATED_FULLY')]
    public function allServices(ServiceRepository $serviceRepo, Request $request): Response
    {
    ...
    public function newService(Request $request, EntityManagerInterface $em, ServiceType $formType): Response
    {
        $service = new Service();
    ...
    public function editService(Request $request, EntityManagerInterface $em, Service $service): Response
    {
    ...
    public function deleteService(Request $request, EntityManagerInterface $em, Service $service): Response
    {
    ...
    public function servicesIndex(ServiceRepository $serviceRepo): Response
    {
