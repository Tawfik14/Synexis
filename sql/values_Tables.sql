...
-- Insertion de donné dans la bdd connected_object
...
-- Insertion de donné dans la bdd connected_object_history
...
-- Insertion de donné dans la bdd contact_message
...
-- Insertion de donné dans la bdd delete_objet_request
